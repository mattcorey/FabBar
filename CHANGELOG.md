...
### Added
- App-controlled floating action visibility with a trailing slide animation
  that recenters the expanded tab control and lets an inline bottom accessory
  fill the vacated trailing space
